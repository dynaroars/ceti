...
#line 91
        tmp___2 = ALIM(Cur_Vertical_Sep, High_Confidence, Two_of_Three_Reports_Valid,
                       ...
                       Climb_Inhibit);
#line 91
        if (Down_Separation > tmp___2) { //tvn: bug  operator error  >=
#line 91
          tmp___3 = 0;
        } else {
#line 91
